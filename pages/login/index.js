  ...
  return (
    <div className="w-full h-screen bg-blue-50 flex items-center">
      <form
        ...
        className="bg-white md:w-2/5 :w-3/4 h-80 mx-auto py-5 px-8 rounded-lg flex flex-col justify-center"
      >
        {showAlert && (
          <Alert
        ...
        <button className="bg-slate-800 text-white py-3 rounded mt-4">
          Login
        </button>
      </form>
    </div>
