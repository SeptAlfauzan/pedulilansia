...
export default function Home() {
  return (
    <div>
      ...
      <Feature />
      {/* <!-- START: PRODUCTS --> */}
      <section className="products bg-black-1">
        ...
        <main className="relative z-30 px-4 pb-0 mx-auto md:pb-28 our-platform pt-36 max-w-screen-2xl lg:px-24">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-12">
            <div className="md:col-span-10">
              <h1 className="font-semibold leading-snug text-white-2 md:leading-9 text-40"> Outputs from Our Platform
              </h1>
              <p className="text-xl font-normal leading-8 md:leading-9 md:text-2xl text-grey-1 mt-7"> Our platform
            ...
            <div className="mt-2 md:col-span-3 lg:col-span-2 lg:mt-0">
              <div className="text-2xl font-semibold text-left bg-transparent text-white-2 lg:text-right"> <a href="#"
                className="px-0 py-0 transition duration-500 ease-out rounded-lg cursor-pointer lg:hover:bg-darkTosca lg:py-3 lg:px-6">See
                more</a> </div>
            </div>
          </div>
          <div className="grid grid-flow-col grid-rows-2 gap-4 mt-12 md:gap-10 md:mt-24">
            ...
            <div className="row-span-1"> <Image objectFit='contain' layout='fill'
            ...
            <div className="grid lg:grid-cols-12">
              <div className="md:col-span-12 lg:col-span-6">
                ...
                <div className="flex flex-row items-center mt-14">
                  <a href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="mr-6"
                      xmlns="http://www.w3.org/2000/svg">
                      <path
                ...
                <p className="mt-5 text-base font-normal text-light-3">
